...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductDTO> list1() {
		...
		ProductDTO product2 = new ProductDTO(2L, "홈런볼", "해태", 1500);
		ProductDTO product3 = new ProductDTO(3L, "바나나킥", "오리온", 2000);
	...
	public List<Map<String, Object>> list2() {
		...
		product2.put("no", 20L);
		product2.put("name", "삼양라면");
		product2.put("maker", "삼양");
		product2.put("price", 1000);
		
		Map<String, Object> product3 = new HashMap<String, Object>();
		product3.put("no", 30L);
		product3.put("name", "진라면");
		product3.put("maker", "오뚜기");
		product3.put("price", 800);
