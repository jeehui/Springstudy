				...
				if($($('.checkOne')).is(':checked')){
					...
					$.ajax({
						...
						success: function(obj){
							deleteCount += obj.res; //성공했다면 res에 1이 들어가 count되고, 실패했다면 res에 0이 들어가 count안됨
						}
	...
	function fnUpdate(){
		$('#btnChange').on('click', function(){
			...
			$.ajax({
				...
				type: 'PUT',
				data: 'member', 
//이름없이 포함되어있는 데이터를 받으려면 RequestBody로 받음 
//controller에 @RequestBody MemberDTO member 데이터가 data: 'member'에 들어감
//POST, PUT 타입에만 가능
