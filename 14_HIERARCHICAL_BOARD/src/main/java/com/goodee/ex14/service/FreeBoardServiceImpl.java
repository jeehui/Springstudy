...
import com.goodee.ex14.domain.FreeBoardDTO;
import com.goodee.ex14.mapper.FreeBoardMapper;
...
public class FreeBoardServiceImpl implements FreeBoardService {
	...
	public int saveReply(HttpServletRequest request) {
		//댓글 작성자와 댓글 내용
				...
				// 댓글 depth    : 원글 depth + 1
				// 댓글 gorupNo  : 원글 groupNo
				// 댓글 groupOrd : 같은 그룹의 기존 댓글 모두 groupOrd + 1 처리 후 원글 groupNo + 1
