...
<script>
	...
	$(document).ready(function(){
		...
		$('#btn2').on('click', function(){fnAjax2();}) // btn2을 클릭하면 fnAjax2()함수를 실행하시오.
		$('#btn3').on('click',fnAjax3) // btn3을 클릭하면 fnAjax3()함수를 실행하시오.
	  ...
	  function fnAjax4(){
		  ...
		  $.ajax({
			  /* 요청 */
		  	  ...
		  	  //JSON 데이터를 주소 창에 붙여서 보내지 못합니다.(get 방식이 아니라는 뜻임)
		  	  //JSON 데이터를 본문에 포함시켜서 보내는 post방식으로 보내야 합니다.
		  	  type: 'post',
