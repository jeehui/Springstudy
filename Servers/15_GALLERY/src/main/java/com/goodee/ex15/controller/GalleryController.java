...
public class GalleryController {
	...
	*/
	...
	public void change(MultipartHttpServletRequest multipartHttpServletRequest, HttpServletResponse response) {
		galleryService.change(multipartHttpServletRequest, response);
	}
